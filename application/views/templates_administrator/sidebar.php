  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('administrator/dashboard'); ?>">
        ...
        <div class="sidebar-brand-text mx-1">PUSKOM KETAPA</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('administrator/artikel') ?>">Artikel</a>
            <a class="collapse-item" href="<?= base_url('administrator/puskom') ?>">Informasi</a>
            <a class="collapse-item" href="<?= base_url('administrator/lowongan') ?>">Lowongan</a>
            <a class="collapse-item" href="<?= base_url('administrator/mahasiswa') ?>">Data Pelamar</a>
